  ...
  <div class="M_out">
  	<div class="M_out_L" style="margin-top:10px;">
        <table class="Search_table">
          ...
          <tr>
            <td class="Search_t_connect">区域</td>
            <td colspan="3" style="padding-left:10px;">${clbSupplyInfo.workArea}</td>
          </tr>
          <tr>
            <td class="Search_t_connect">企业性质</td>
            <td colspan="3" style="padding-left:10px;">${clbSupplyInfo.companytype}</td>
          </tr>
           <tr>
            <td class="Search_t_connect">业务范围</td>
