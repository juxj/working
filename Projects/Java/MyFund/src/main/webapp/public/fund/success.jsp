...
<div class="container_960">
  		<div class="box_948">
          <div class="fl" style="padding-top:20px;padding-left:60px;padding-right:20px;padding-bottom:40px;"><img src="/images/right_ico.png"/></div>
          <div class="txt_content" >  		
		  <h5 class="red">您的预约申请成功提交!</h5>
		  </div>
		</div>
</div>
<!--主体部分结束-->
