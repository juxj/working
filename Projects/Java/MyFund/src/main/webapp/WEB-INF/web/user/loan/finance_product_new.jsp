...
<div class="hr_10"> &nbsp; </div>
  <div class="M_menu">
  	<div style="float: left;"><a href="#">首页</a>&nbsp;&nbsp;<b>></b>&nbsp;&nbsp;<a href="#">融资管理</a>&nbsp;&nbsp;<b>></b>&nbsp;&nbsp;<a href="/user/loan/financeProduct.act">融资产品管理</a>&nbsp;&nbsp;<b>></b>&nbsp;&nbsp;<a href="#">融资产品发布</a></div>
  </div>
<div class="hr_10"> &nbsp; </div>
<!--主体部分开始-->
...
<s:hidden name="financeProductSpModel.rateEnId" id="rateEnId"></s:hidden>
	...
	<div class="C_form">
		<dl>
           <dd>
			...
			<dd>
                <h6>贷款产品介绍：</h6>
                <s:textarea name="product.proIntroduce" cols="60" rows="5" onKeyDown="validate_maxlength(this,100,'prointroduce');" onKeyUp="validate_maxlength(this,100,'prointroduce');"></s:textarea>
                <label class="error prointroduce" generated="true" style="display:none;">最多输入100个字符</label>
              </dd>
		</dl>
	</div>
	<div class="clear"></div>
	...
	<div class="C_form">
		<dl>
              ...
              <dd>
                <h6>其他申请条件：</h6>
                <s:textarea name="product.otherRequire" cols="60" rows="5" onKeyDown="validate_maxlength(this,100,'otherrequire');" onKeyUp="validate_maxlength(this,100,'otherrequire');" id="product_otherRequire" ></s:textarea>
                <label class="error otherrequire" generated="true" style="display:none;">最多输入100个字符</label>
