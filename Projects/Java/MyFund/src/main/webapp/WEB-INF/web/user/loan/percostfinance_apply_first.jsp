...
<script type="text/javascript" src="/script/jquery.validate.min.js">
	
</script>
<script type="text/javascript"
	src="/script/jquery-ui-1.8.21.custom.min.js">
...
<body>
	...
	<div class="apply_form">
		<form action="/applyadmin/financeApply!applySecond.act" id="applyForm" method="post" class="box_form" style="margin:0px;">
			...
			<div class="C_title">
				融资需求信息&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red;">${msg
					}</span>
			</div>
			<div class="C_form">
				<dl>
					<dd>
						<h6>
							<span class="txt-impt">*</span>贷款用途：
						</h6>
						<common:select name="apply.loanPurpose" valueSetId="14"
							cssClass="S_width input-text"></common:select>
						<h6>贷款金额：</h6>
						<s:textfield name="apply.loanAmount"
							cssClass="input-text required number" id="apply.loanAmount"></s:textfield>
						&nbsp;&nbsp;万元 <label for="apply.loanAmount" class="error"
							generated="true" style="display:none;"></label>
					</dd>
					<dd>
						<h6>贷款期限：</h6>
						<s:textfield name="apply.loanMonth"
							cssClass="input-text required digits" id="apply.loanMonth"></s:textfield>
						&nbsp;&nbsp;个月 <label for="apply.loanMonth" class="error"
							generated="true" style="display:none;"></label>
					</dd>
					<dd>
						<h6>是否有抵押物：</h6>
						<input id="radio1" type="radio" name="apply.haveMortgage"
							value="1" class="required" checked /><label for="radio1">能提供</label>
						<input id="radio2" type="radio" name="apply.haveMortgage"
							value="0" /><label for="radio2">无法提供</label>
					</dd>
				</dl>
			</div>
			<div class="clear"></div>
			...
			<div class="C_form">
				<dl>
					...
					<dd>
						<h6>自有房产：</h6>
						<s:radio name="apply.haveHouse" value="1" list="%{#{1:'有',0:'无'}}"
							cssClass="required"></s:radio>
						<label for="apply.haveHouse" class="error" generated="true"
							style="display:none;"></label>
					</dd>
					<dd>
						<h6>银行借款经历：</h6>
					...
					<dd>
						<h6>银行流水：</h6>
						<s:radio name="apply.bankSalaryList" value="1"
							list="%{#{1:'能提供',0:'无法提供'}}" cssClass="required"></s:radio>
						<label for="apply.bankSalaryList" class="error" generated="true"
							style="display:none;"></label>
					</dd>
				</dl>
				<div class="hr_10">&nbsp;</div>
