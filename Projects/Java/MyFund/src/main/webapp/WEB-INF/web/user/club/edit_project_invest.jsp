	...
	<form action="/service/supplyInfoAction4User!save.act" id="frmProjectInvest" method="post">
		...
		<table class="form_table">
			...
			<tr>
				...
				<td>
					<s:radio list="amountRangeList.{?#this.code<10000}" listKey="name" listValue="name"  cssClass="required" name="clbSupplyInfo.workTranche"></s:radio>
				</td>
			</tr>
			<tr>
				...
				<td><s:select list="timeIntervalList" listKey="code" 
					...
					name="lastDisplayDate" ></s:select></td>
			</tr>
			<tr>
