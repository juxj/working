...
<div class="apply_title" >
	...
	<div class="apply_menu">
        ...
        <div class="finance_apply_menu app_menu002">3.预审中</div>
...
<div class="S_table">
	...
	<div class="S_table_connect">
		...
		<s:else>		
			...
			<span class="Prompt_02">&nbsp;&nbsp;您本次贷款申请单号为<a href="/user/loan/financeApply!viewFinanceApply.act?apply.id=${apply.id }">${apply.applyNum }</a></span><br/>
