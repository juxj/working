...
function vershow(){
	$.post("/Account!sendMoblie.act",function(a){
		$("#pop_verCode").dialog({width:500,modal:true});
		if(a!='success'){
			$("#mobileMsg").html(a);
		}
	});
...
<div class="hr_10"> &nbsp; </div>
<div class="M_menu">
<a href="/user/UserAction.act">用户中心</a>&nbsp;&nbsp;<b>></b>&nbsp;&nbsp;<a href="#">账户管理</a>&nbsp;&nbsp;<b>></b>&nbsp;&nbsp;<a href="/user/regInfo.act">注册信息</a>
</div>
<div class="hr_10"> &nbsp; </div> 
<!--改动的部分-->
    ...
    <div class="box_4 center container_950">
	    <div class="hr_20"> &nbsp; </div>
	    	...
	    	<div class="fl" style="width:60%; height:30px"><s:if test="#session._user.activetype != 3"><input  name="upload_img" value="验证" type="button" onclick="vershow();" class="but_gray"/></s:if>&nbsp;</div>
	    	...
	    	<div class="fl" style="width:60%; height:30px"><!-- <s:if test="#session._user.activetype==2 || #session._user.activetype==3"><input  name="upload_img" value="验证" type="button" class="but_gray"/></s:if> -->&nbsp;</div>
	    <div class="hr_20"> &nbsp; </div>
	    <div class="hr_20"> &nbsp; </div>
