...
<!--主体部分开始-->
  <div class="M_menu">
  	<a href="#">首页</a>&nbsp;&nbsp;<b>></b>&nbsp;&nbsp;<a href="#">融资管理</a>&nbsp;&nbsp;<b>></b>&nbsp;&nbsp;<a href="/user/loan/financeApply!applyManag.act">融资申请管理</a>&nbsp;&nbsp;<b>></b>&nbsp;&nbsp;<a href="#">融资申请查看</a>
  </div>
<div class="hr_10"> &nbsp; </div>
...
<div class="hr_10"> &nbsp; </div>
<form action="/user/loan/financeApply!checkApply.act" id="loanForm"  class="box_form" style="margin:0px;" method="post">
<!-- 企业经营贷款快速申请类型=136 -->
...
<div class="apply_form">
	...
	<table class="apply_form_tb" style="float:left; width:550px;">
	  <tr>
	    ...
	    <td class="p_td" width="300px;"><common:print valueId="apply.applyStatus"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="apply_form">
	...
	<table class="apply_form_tb">
	  <tr>
		...
		<td style="font-size: 16px;" colspan="3">&nbsp;&nbsp;${product.financeName }&nbsp;(${product.financeNum})</td>
	  </tr>
              <tr>
	...
	<table class="apply_form_tb">
			<s:if test="#session._user.userTypeGroup == 2 || #session._user.userTypeGroup == 3">
              ...
              <tr>
                ...
                <td class="p_td" width="180px"><common:print valueId="apply.loanPurpose" /></td>
                <td class="r_td">贷款金额：</td>
	...
	<table class="apply_form_tb">
		...
		<tr>
			<td class="r_td">第二大下游客户与您的合作时长：</td>
			<td class="p_td">${apply.nextCustomTime}&nbsp;&nbsp;年</td>
		</tr>
		<tr>
			<td class="r_td">以上两家客户占您年销售额比率：</td>
			<td class="p_td">${apply.twoCusSalerate}&nbsp;&nbsp;%</td>
		</tr>
		<tr>
