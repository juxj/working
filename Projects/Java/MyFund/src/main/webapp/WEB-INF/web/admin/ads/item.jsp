...
function edit(id){
	document.location.href="/admin/ads/item!edit.act?itemId="+id;
}
function remove(id){
...
function addPlace(){
	document.location.href="/admin/ads/item!bfAdd.act";
}
</script>
</head>
<body>
	...
	<div class="wrapper">
		...
		<div class="block">
			...
			<div class="block_head">
				...
				<h2>广告管理 » 广告项管理</h2>
				<ul>
					<li class="nobg"><input type="button" value="新增广告项" onclick="addPlace();"/></li>
				</ul>
			</div>
			<!-- .block_head ends -->
				...
				<table cellpadding="0" cellspacing="0" width="100%" class="tablesorter">
					<thead>
						<tr style="background:#DDDDDD;">
							<th class="header" style="cursor: pointer; ">名称</th>
							<th class="header" style="cursor: pointer; ">内容</th>
							<th width="180px;">操作</th>
						</tr>
					</thead>
					<tbody>
						<s:iterator value="itemList" var="u" status="i">
