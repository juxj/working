...
<div id="agree_num_input" style="display:none;" title="输入协议编号">
	<dl>
		<dd>
			...
			<input type="button" value="确定" class="but_gray" onclick="if($('#agreeNumInput').val().length > 0){agreeNumInput($('#agreeNumInput').val());$('#agree_num_input').dialog('close');}else{alert('请输协议编号');}"/>
		</dd>
	</dl>
</div>
