...
public class PaymentQuery{
	...
	public void queryTrans(String transType, String orderNumber, String orderTime) {
		...
		if (res != null && !"".equals(res)) {
			...
			String[] arr = PaymentUtils.getResArr(res);
	...
	public String query(String transType, String orderNumber, String orderTime) {
		...
		return paymentUtils.doPostQueryCmd(PaymentConf.queryUrl,new PaymentUtils().createBackStr(valueVo, PaymentConf.queryVo));
	...
	public boolean checkSecurity(String[] arr){
		//验证签名
		int checkedRes = new PaymentUtils().checkSecurity(arr);
		if(checkedRes==1){
			return true;
