...
<!--头部结束-->
  <!--理财服务产品列表页面开始-->
  <div class="M_menu">
  	<a href="#">首页</a>&nbsp;&nbsp;<b>></b>&nbsp;&nbsp;<a href="#">融资管理</a>&nbsp;&nbsp;<b>></b>&nbsp;&nbsp;<a href="/user/loan/financeApply!applyManag.act">融资申请管理</a>&nbsp;&nbsp;<b>></b>&nbsp;&nbsp;<a href="/user/loan/financeAttach!attachMana.act?viewAttachType=${viewAttachType }&applyId=${applyId}">资料管理</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#97181d;">${msg }</span>
  </div>
  <div class="hr_10"> &nbsp; </div> 
  <div class="hr_10"> &nbsp; </div> 
  <div class="M_box">
