...
<div class="container_960">
  <div class="user_box">
    <div class="user_info fl"> <img class="user_logo fl" src="<s:if test="#session._user.avatar!=null">${session._user.avatar}</s:if><s:else>/images/member_logo.jpg</s:else>" alt="${session._user.realname}" />
      ...
      <span id="mail">
        	<s:if test="#session._user.activetype==1"><a class="mail_on" title="Email已认证"></a></s:if><s:else><a class="mail_off" title="Email未认证"></a></s:else>
        </span>
        <span id="mobile">
        	<s:if test="#session._user.activetype==2"><a class="mobile_on" title="手机号码已认证"></a></s:if><s:else><a class="mobile_off" title="手机号码未认证"></a></s:else>
        </span>
